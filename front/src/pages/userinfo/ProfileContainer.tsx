            ...
            icon: (
              <svg width="23" height="25" viewBox="0 0 23 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  clipRule="evenodd"
                  className={
                    selectedTab === "capsules" ? "fill-primary dark:fill-primary-dark" : "fill-black dark:fill-white"
                  }
          ...
          },
          {
            ...
            icon: (
              <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  className={
                    selectedTab === "articles" ? "fill-primary dark:fill-primary-dark" : "fill-black dark:fill-white"
                  }
